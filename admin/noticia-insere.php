...
if (isset($_POST['inserir'])) {
	...
	$texto = $_POST['texto'];
	$resumo = $_POST['resumo'];
	/* Obtendo o id do usuario que está logado e inserindo a noticia. Portanto a noticia esta associada ao usuario devido ao uso de chave estrangeira e relacionamento no banco */
	$usuarioId = $_SESSION['id'];

	/* Capturando dados dp arquivo enviado */
...
<div class="row">
	<article class="col-12 bg-white rounded shadow my-1 py-4">
		...
		<!-- O atributo enctype com o valor indicado é necessário quanto queremos que o formulário aceite o envio/processamento de arquivos pdf, imagem etc. -->
