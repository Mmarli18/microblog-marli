...
// Chamar a função e recuperar os dados da noticia
...
if (isset($_POST['atualizar'])) {
    ...
    /* Se o campo imagem estiver vazio, então significa que o usuário não quer alterar a imagem, Neste caso o sistema vai manter a "imagem existente"  */
